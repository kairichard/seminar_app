...
public class AlgoVizAboutBox extends javax.swing.JDialog {

    public AlgoVizAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(algoviz.AlgoVizApp.class).getContext().getResourceMap(AlgoVizAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(algoviz.AlgoVizApp.class).getContext().getActionMap(AlgoVizAboutBox.class, this);
