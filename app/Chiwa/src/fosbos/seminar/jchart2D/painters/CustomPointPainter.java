/*
 *  CustomPointPainter.java, a point painter that renders a bar 
 *  for each point.
 ...
 */
package fosbos.seminar.jchart2D.painters;
 ...
 * 
 */
public final class CustomPointPainter extends APointPainter<CustomPointPainter> {
     ...
     */
    public CustomPointPainter(final Chart2D chart) {
        this(4, chart);
    }
     ...
     *          the corresponding chart for bound information.
     */
    public CustomPointPainter(final int barWidth, final Chart2D chart) {
    ...
    public boolean equals(final Object obj) {
        ...
        final CustomPointPainter other = (CustomPointPainter) obj;
    ...
    public void paintPoint(final int absoluteX, final int absoluteY, final int nextX,
        ...
        APointPainter[] a = new APointPainter[original.getAdditionalPointPainters().size()];
        Iterator<IPointPainter<?>> iterator = original.getAdditionalPointPainters().iterator();
        while(iterator.hasNext()){
            APointPainter element = (APointPainter) iterator.next();            
            g.setColor(element.getColor());
            g.fillRect(absoluteX - this.m_halfWidth, absoluteY, 2 * this.m_halfWidth, this.m_chart.getYChartStart()
                - absoluteY);
        }
    }
