/*
 *  PointPainterBlank.java, a point painter that renders a bar 
 *  for each point.
 ...
 * 
 */
public final class PointPainterBlank extends APointPainter<PointPainterBlank> {
     ...
     */
    public PointPainterBlank(final Chart2D chart) {
        this(4, chart);
    }
     ...
     *          the corresponding chart for bound information.
     */
    public PointPainterBlank(final int barWidth, final Chart2D chart) {
    ...
    public boolean equals(final Object obj) {
        ...
        final PointPainterBlank other = (PointPainterBlank) obj;
